...
import {clearModel, saveModel,setFileName, useDEMOModelerStore,} from "$/features/modeler/useDEMOModelerStore";
...
import {saveServerFile} from "$features/backend/useBackendStore.ts";
...
const FileMenu = () => {
    ...
    function getSaveOnServer() {

        if ((localStorage.getItem('yadm-auth-key') || '') !== '') {
            ...
            return (
                <TopbarMenuItem
                    onAction={() => {
                        saveServerFile().then(() => {
                            toast.success(
                                t(($) => $["save_on_server_storage_toast"], {fileName: fileName})
                            );
                        });
                    }}
                >
        ...
        <>
            ...
            <DEMOModal
                ...
                onAction={() => {
                    ...
                    localStorage.removeItem("demo-model");setFileName("New model");clearModel();
